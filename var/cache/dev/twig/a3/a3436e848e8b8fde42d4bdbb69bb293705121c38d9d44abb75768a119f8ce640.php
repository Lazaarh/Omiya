...
class __TwigTemplate_d671b2fa462bd67db32d924b4545b06b766b20852647dd553a39440b0600107c extends Template
{
    ...
    Bienvenue <strong>";
        ...
        echo "</strong> dans votre espace personnel.
    <hr>
        ";
        // line 9
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) {
            // line 10
            echo "    - <a href=\"/admin\">BackOffice Admin</a><br/>
        ";
        } else {
            // line 12
            echo "    - <a href=\"";
...
";
    ...
    {
        return array (  118 => 16,  113 => 14,  109 => 13,  104 => 12,  100 => 10,  98 => 9,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block content %}
    <h1>Mon compte</h1>
    Bienvenue <strong>{{ app.user.firstname }} {{ app.user.lastname }}</strong> dans votre espace personnel.
    <hr>
        {% if is_granted('ROLE_ADMIN') %}
    - <a href=\"/admin\">BackOffice Admin</a><br/>
        {% else %}
    - <a href=\"{{ path('account_password') }}\">Modifier mon mot de passe</a><br/>
    - <a href=\"{{ path('account_address') }}\">Mes adresses</a><br/>
    - <a href=\"{{ path('account_order') }}\">Mes commandes</a><br/><br/>
        {% endif %}
    <hr>
{% endblock %}
", "account/index.html.twig", "C:\\Users\\Utilisateur\\Desktop\\Symfony\\OmiyaProject\\Omiya-Site-Ecommerce-main\\templates\\account\\index.html.twig");
    }
}
